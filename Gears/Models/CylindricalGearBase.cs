...
namespace Gears.Models
{
    ...
    class CylindricalGearBase
    {
        ...
        public void CopyInputFrom(CylindricalGearBase target) {
            var type = typeof(CylindricalGearBase);
        ...
        public void CopyInputTo(CylindricalGearBase target)
        {
            var type = typeof(CylindricalGearBase);
            foreach (var property in type.GetProperties())
            {
        ...
        public bool HasSameInputWith(CylindricalGearBase  target)
        {
            if (target == null)
            {
                return false;
