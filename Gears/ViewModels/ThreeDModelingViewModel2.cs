...
{
    class ThreeDModelingViewModel2 : Gears.Models.CylindricalGear, INotifyPropertyChanged
    {
        ...
        public ThreeDModelingViewModel2(GearDetailViewModel gearDetailViewModel)
        {
